...
# What we covered:
#
# - Recovered known parameters from simulated AR(1), MA(1), ARMA(1,1)
# - Showed that misspecification leads to worse AIC/BIC
# - Demonstrated differencing for nonstationary series (the "I" in ARIMA)
# - Fit multiple ARMA models to inflation and IP growth
# - Ran Ljung-Box tests on residuals
# - Interpreted AR coefficients in terms of persistence and half-life
# - Showed both base arima() and fable::ARIMA() give the same answers
# - Previewed seasonal ARIMA
#
# Next file: forecasting with ARIMA models.